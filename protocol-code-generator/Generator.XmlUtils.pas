...
begin
  ...
  while Assigned(Child) do begin
    if (Child.NodeType = ELEMENT_NODE) and
       (Child.NodeName = 'field') or
       (Child.NodeName = 'array') or
       (Child.NodeName = 'length') or
       (Child.NodeName = 'dummy') or
       (Child.NodeName = 'switch') or
       (Child.NodeName = 'chunked') or
       (Child.NodeName = 'break') then
    begin
